        ...
        <div className="grid xl:grid-cols-2  lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 xs:grid-cols-1  h-screen w-full container mx-auto ">
          <div className="flex flex-col items-start justify-center h-full">
            ...
            <div className="w-full h-[10%] mt-6">
              <div className=" font-bold h-[20%]   dark:text-[#80C4E9] text-center md:text-left">
                <h4>
            ...
            <button className="mt-4 border-2 border-[#4335A7]  px-5 py-1 rounded-md font-bold text-[#4335A7]">
              <h6>Get started</h6>
            </button>
          </div>
